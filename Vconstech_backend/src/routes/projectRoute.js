...
// router.get('/:id/files/:fileId/download', checkProjectAccess, downloadProjectFile);
...
// Body: { fileIds: [1, 2, 3] }
router.post('/:id/files/download-zip', checkProjectAccess, downloadProjectFilesZip);
...
router.post('/:id/folders', checkProjectAccess, createProjectFolder);
 
// ✅ NEW: List folders for a project (includes file count per folder)
router.get('/:id/folders', checkProjectAccess, getProjectFolders);
