...
router.post(
  ...
  async (req, res) => {
    ...
    let createResult;
    try {
      const createRes = await fetch('https://erp.vconstech.in/api/superadmin/create-user', {
        method: 'POST',
      ...
      html: `
        <div style="font-family:sans-serif;max-width:520px;margin:auto">
          ...
          <div style="background:#fff8e1;border:1px solid #ffbe01;border-radius:10px;padding:20px;margin:20px 0">
            ...
            <p style="margin:6px 0;font-size:14px"><strong>URL:</strong> <a href="https://erp.vconstech.in">https://erp.vconstech.in</a></p>
