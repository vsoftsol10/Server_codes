...
const SidePannel = () => {
  ...
  const sidebarLinks = [
    ...
    { name: "Material Management", path: "/material", icon: materialIcon },
    {
      ...
      submenu: [
        ...
        {
          name: "Billing",
          path: "/financial-management/billing",
          icon: billing,
        },
      ],
    },
    ...
    { name: "File Management", path: "/file-managememt", icon: fileIcon },
    {
      ...
      path: "/labor-managememt",
      icon: laborManagementIcon,
    },
  ...
  return (
    <>
      ...
      <div className="fixed top-20 left-0 md:w-65 w-16 hover:w-64 border-r border-gray-300 bg-white h-[calc(100vh-5rem)] md:overflow-y-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-400 overflow-x-hidden transition-all duration-300 z-50 group">
    ...
    ${item.name === "Logout" ? "mt-4" : ""}`}
              >
                ...
                <p className="hidden group-hover:block md:block text-sm md:text-base whitespace-nowrap flex-1">
                  {item.name}
                </p>
                {item.submenu && (
            ...
            location.pathname === subItem.path
              ...
              : "hover:bg-black/5 text-gray-700"
                    ...
                    >
                      ...
                      <p className="text-[10px] md:text-sm block whitespace-nowrap overflow-hidden text-ellipsis">
                        {subItem.name}
                      </p>
                    </button>
                  ))}
